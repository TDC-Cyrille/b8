...
class standard
{
    ...
    public $words_to_ignore = array( 'a', 'an', 'the', 'in', 'of', 'on', 'are', 'be', 'if', 'into', 'which', 'you', 'i', 'this', 'that', 'may', 'we', 'you', 'our', 'to', 'my', 'your', 'am', 'and', 'when', 'us', 'is', 'on', ',', '.', 'please', 'no', 'but', 'will', 'i\'ll', 'he\'ll', 'she\'ll', 'you\'ll', 'please', 'can', 'like', 'yours', 'ours', 'theirs', 'who', 'what', 'for', 'has', 'had', 'not', 'i\'ve', 'you\'ve', 'with', 'i\'m', 'you\'re' );
    ...
    public function get_tokens(string $text)
    {
        ...
        $this->processed_text = strtolower( html_entity_decode($text, ENT_QUOTES, 'UTF-8') );
    ...
    private function add_token(string $token, string $word_to_remove = null)
    {
        ...
        if( in_array( $token, $this->words_to_ignore ) === false ) {
